...
export default function ServiceConnectSignup() {
  ...
  const isWorkerFormReady = !isWorker || (
    formData.tradeCategory.trim() !== "" &&
  ...
  const handleGoogleSignup = () => {
    ...
    if (isWorker) {
      if (!formData.tradeCategory) {
        toast.error("Please select a trade category first!");
        return;
      }
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ width: "320px", backgroundColor: AUTH_THEME.surfaceAlt }}
        >
          {/* Logo */}
          <div>
            ...
            >
              <button
                ...
                style={{
                  ...
                  color: activeRole === "client" ? "#0d1a1a" : AUTH_THEME.muted,
                }}
              >
                Client
              </button>
              <button
                ...
                style={{
                  ...
                  color: activeRole === "professional" ? "#0d1a1a" : AUTH_THEME.muted,
                }}
              >
                Professional
              </button>
          ...
          <div className="min-h-0 flex-1 overflow-y-auto pr-1">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3 pb-2">
                    ...
                    {geoStatus.message && (
                      <p
                        style={{
                          margin: 0,
                          fontSize: "11px",
                          color: geoStatus.type === "error" ? "#f87171" : geoStatus.type === "success" ? AUTH_THEME.successText : AUTH_THEME.muted,
                        }}
                      >
                        {geoStatus.message}
                      </p>
              ...
              {statusMessage && (
                <p
                  style={{
                    ...
                    border: `1px solid ${statusType === "success" ? AUTH_THEME.successBorder : "rgba(248,113,113,0.25)"}`,
                  }}
                >
                  {statusMessage}
                </p>
              ...
              <div className="flex items-center gap-3 my-1">
                ...
                <span style={{ fontSize: "11px", color: AUTH_THEME.muted, fontWeight: 600, letterSpacing: "0.08em" }}>
                  Or
                </span>
                <div style={{ flex: 1, height: "1px", background: AUTH_THEME.border }} />
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  height: "50px",
                  width: "100%",
                  background: !isWorkerFormReady
                    ? "rgba(13,26,26,0.5)"
                    : "#0d1a1a",
                  border: `1px solid ${!isWorkerFormReady
                    ? "rgba(26,51,51,0.5)"
                    : AUTH_THEME.border
                    }`,
                  borderRadius: "10px",
                  color: !isWorkerFormReady
                    ? "#3a5a5a"
                    : "#b0c8c8",
                  fontSize: "13px",
                  fontWeight: 700,
                  cursor: !isWorkerFormReady
                    ? "not-allowed"
                    : "pointer",
                  transition: "all 0.15s",
                  opacity: !isWorkerFormReady ? 0.5 : 1,
                }}
                onMouseEnter={e => {
                  if (isWorkerFormReady) {
              ...
              {isWorker && !isWorkerFormReady && (
                <p style={{
                  ...
                  ⚠️ Fill in trade category, experience
                  and service area to continue with Google
                </p>
              )}
              {/* Submit */}
              <button
              ...
              {/* Footer link */}
              <p style={{ textAlign: "center", fontSize: "12px", color: AUTH_THEME.muted, marginTop: "6px" }}>
...
function PasswordRequirement({ met, label }) {
  return (
    ...
    >
      {met ? (
        <Check size={14} color="#b7d0d0" strokeWidth={2.4} />
      ) : (
